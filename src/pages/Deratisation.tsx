        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">
              Dératisation à Perpignan - Intervention Rapide et Efficace
            </h1>
            
            <div className="prose prose-lg max-w-none mb-8">
              <p className="text-lg text-muted-foreground mb-6">
                Vous faites face à une infestation de rats ou de souris à Perpignan ? Notre équipe d'experts certifiés intervient rapidement pour éliminer ces nuisibles de manière définitive et sécurisée.
              </p>

              <h2 className="text-2xl font-bold mt-8 mb-4">Pourquoi choisir notre service de dératisation ?</h2>
              
              <p className="mb-4">
                Les rongeurs représentent un danger sanitaire majeur pour votre habitation ou votre entreprise. Ils peuvent contaminer vos aliments, endommager vos installations électriques et transmettre des maladies graves. Notre service de dératisation professionnel à Perpignan utilise des méthodes éprouvées et respectueuses de l'environnement pour garantir l'élimination complète des rats et souris.
              </p>

              <p className="mb-4">
                Nous intervenons dans tout Perpignan et les Pyrénées-Orientales avec des techniciens formés et certifiés CERTIBIOCIDE. Notre approche combine diagnostic précis, traitement adapté et suivi rigoureux pour assurer des résultats durables. Que vous soyez un particulier ou un professionnel, nous proposons des solutions sur mesure adaptées à votre situation.
              </p>
              ...
              <p className="mb-6">
                Nos tarifs sont transparents et nos devis gratuits. Contactez-nous dès maintenant pour une intervention rapide et discrète à Perpignan.
              </p>
            </div>
