        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">
              Intervention Rapide Anti-Nuisibles - Disponible 7j/7 à Perpignan
            </h1>
            
            <div className="prose prose-lg max-w-none mb-8">
              <p className="text-lg text-muted-foreground mb-6">
                Besoin d'une intervention rapide contre les nuisibles à Perpignan ? Notre équipe se déplace en urgence 7j/7 pour traiter rats, souris, cafards, punaises de lit, guêpes et frelons. Devis gratuit et réactivité garantie sous 24h.
              </p>

              <h2 className="text-2xl font-bold mt-8 mb-4">Réactivité et professionnalisme garantis</h2>
              
              <p className="mb-4">
                Face à une invasion de nuisibles, la rapidité d'action est essentielle. Chaque jour d'attente permet aux rats, cafards, punaises de lit ou autres nuisibles de se multiplier et d'aggraver l'infestation. Notre entreprise spécialisée dans la lutte contre les nuisibles intervient rapidement à Perpignan et dans les Pyrénées-Orientales, généralement sous 24 heures, week-ends et jours fériés compris.
              </p>
