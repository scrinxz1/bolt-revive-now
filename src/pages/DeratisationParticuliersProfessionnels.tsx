        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">
              Dératisation pour Particuliers et Professionnels à Perpignan
            </h1>
            
            <div className="prose prose-lg max-w-none mb-8">
              <p className="text-lg text-muted-foreground mb-6">
                Entreprise de dératisation à Perpignan intervenant auprès des particuliers et professionnels. Solutions adaptées à chaque besoin : habitations, restaurants, hôtels, commerces, entrepôts. Devis gratuit et intervention rapide 7j/7.
              </p>

              <h2 className="text-2xl font-bold mt-8 mb-4">Dératisation pour particuliers</h2>
              
              <p className="mb-4">
                Vous avez repéré des traces de rats ou de souris dans votre maison, appartement, garage ou jardin ? Ne laissez pas la situation s'aggraver. Les rongeurs se reproduisent très rapidement et peuvent causer d'importants dégâts : câbles électriques rongés, isolation détériorée, denrées alimentaires contaminées, risques sanitaires pour votre famille. Notre équipe certifiée intervient rapidement à votre domicile à Perpignan pour un traitement professionnel et discret.
              </p>
